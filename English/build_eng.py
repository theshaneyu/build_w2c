...
WIKI_DUMP_FILEPATH = os.path.join(DATA_PATH, sys.argv[1])
...
if __name__ == '__main__':
    ...
    model = gensim.models.Word2Vec(sentences=sentences, size=int(sys.argv[2]), min_count=1, window=5, workers=cores)

    # Save model
    logging.info('Saving model..')
    model.save(os.path.join(MODEL_PATH, 'word2vec.model.'+sys.argv[2]))
